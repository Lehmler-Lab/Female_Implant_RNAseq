...
```{r}
se1<- se[,se$tissue_type == "CRBLM"] ##change tissue type here
...
#PCA Plot
```{r}
tiff(file = 'Figures/PCA/Female_CRBLM_PCA.tiff', units="in", width=8, height=5, res=1000)
...
```{r}
tiff(file = "Figures/heatmap/female_CRBLM_heatmap.tiff", units="in", width=8, height=5, res=1000)
...
write_tsv(High_resOrdered, file="Result_spreadsheets/High_female_CRBLM_results.tsv")
write_csv(High_resOrdered, file="Result_spreadsheets/High_female_CRBLM_results.csv")
write_csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/female_CRBLM_counts.csv")
```
...
write_tsv(medium_resOrdered, file="Result_spreadsheets/Medium_female_CRBLM_results.tsv")
write_csv(medium_resOrdered, file="Result_spreadsheets/Medium_female_CRBLM_results.csv")
write_csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/Medium_female_CRBLM_counts.csv")
```
...
write_tsv(low_resOrdered, file="Result_spreadsheets/Low_female_CRBLM_results.tsv")
write_csv(low_resOrdered, file="Result_spreadsheets/Low_female_CRBLM_results.csv")
write_csv(as.data.frame(assay(se1)), file= "Result_spreadsheets/Low_female_CRBLM_counts.csv")
```
...
```{r}
tiff(file = 'Figures/Enrichment/High_female_CRBLM_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot<-dotplot(Mgse, showCategory=5, split=".sign") +
  ...
  ggtitle("High female Cerebellum Gene Enrichment")  
...
tiff(file = 'Figures/Enrichment/High_female_CRBLM_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot2<-dotplot(Mkk2, showCategory=5, split=".sign") +
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("High female Cerebellum KEGG Enrichment")
...
```{r}
tiff(file = 'Figures/Enrichment/Medium_female_CRBLM_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot3<-dotplot(Mgse, showCategory=5, split=".sign") +
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Medium female Cerebellum Gene Enrichment")  
...
tiff(file = 'Figures/Enrichment/Medium_female_CRBLM_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot4<-dotplot(Mkk2, showCategory=5, split=".sign") +
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Medium female Cerebellum KEGG Enrichment")   
...
```{r}
tiff(file = 'Figures/Enrichment/Low_female_CRBLM_gene_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot5<-dotplot(Mgse, showCategory=5, split=".sign") +
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Low female Cerebellum Gene Enrichment")
...
tiff(file = 'Figures/Enrichment/Low_female_CRBLM_KEGG_enrichment.tiff', units="in", width=7, height=5, res=1000)
dot6<-dotplot(Mkk2, showCategory=5, split=".sign") +
  ...
  theme(axis.text.y = element_text(size = 12), 
        strip.background = element_blank(), strip.text.x = element_text(size = 16)) +
  theme(legend.text = element_text(size = 10),legend.key.width= unit(0.3, 'cm'))+
  ggtitle("Low female Cerebellum KEGG Enrichment")  
...
data<-data.frame(CRBLM_groups)
write.csv(data ,file="Figures/Enrichment/Grouped_CRBLM_Gene_enrichment.csv")
```
...
data<-data.frame(CRBLM_groups)
write.csv(data ,file="Figures/Enrichment/Grouped_CRBLM_KEGG_enrichment.csv")
```
...
data<-data.frame(CRBLM_groups)
write.csv(data ,file="Figures/Enrichment/Grouped_CRBLM_Disease_enrichment.csv")
```
